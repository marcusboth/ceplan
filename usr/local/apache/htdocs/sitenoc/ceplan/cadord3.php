...
for($f=0;$f<$contadorplantao;$f++)
{
 ...
 $resultado = mysql_query($sql)
 or die ("Não foi possível realizar a consulta ao banco de dados $ultnumseq $periodo $dia  $flag $numplant  $madrugaa  $madrugab  $manhaa  $manhab  $tardea  $tardeb  $noitea  $noiteb");
}
...
$resultado = mysql_query($sql)
or die ("Não foi possível realizar a consulta ao banco de dados $ultnumseq");
