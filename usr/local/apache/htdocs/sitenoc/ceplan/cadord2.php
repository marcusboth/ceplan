...
echo "$HTTP_POST_VARS[ord12] -  $HTTP_POST_VARS[nome12] - $HTTP_POST_VARS[usaldo12]<BR>";
echo "$HTTP_POST_VARS[ord13] -  $HTTP_POST_VARS[nome13] - $HTTP_POST_VARS[usaldo13]<BR>";
...
$tab[12]="$ordtmp[12]-;-$mesini;trim3de3i;0;$HTTP_POST_VARS[nome12];0.0;0;$HTTP_POST_VARS[usaldo12];0;;";
$tab[13]="$ordtmp[13]-;-$mesini;trim3de3i;0;$HTTP_POST_VARS[nome13];0.0;0;$HTTP_POST_VARS[usaldo13];0;;";
...
print "<input type='HIDDEN' name='tabord12' value='$tabordmem[12]'>";
print "<input type='HIDDEN' name='tabord13' value='$tabordmem[13]'>";
